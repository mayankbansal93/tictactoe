    ...
    public void onClick(View view) {
        if (type && h.containsKey(view.getId()) && check[h.get(view.getId()) / 3][h.get(view.getId()) % 3] == 0) {
            ...
            if (!ans) {
                ...
                Intent i1 = new Intent(SixthActivity.this, FourthActivity.class);
                startActivity(i1);
                finish();
            } else {
                if (complete()) {
                    ...
                    if(h.size()==8){
                        ...
                        if(second){
                            if((check[0][0]==check[2][2] && check[0][0]==1) || (check[0][2]==check[2][0] && check[0][2]==1)){
                                int w=r.nextInt(4);
                                num=2*w+1;
                            }else{
                                num = generatePos1();
                                ...
                                if (num < 0) {
                                    ...
                                    }else if(check[1][0]==1 || check[1][2]==1){
                                        if(ran==0){
                                            if(check[0][1]==0){
                                                num=1;
                                            }else {
                            ...
                            int ran=r.nextInt(2);
                            if((check[0][0]!=0 && check[2][2]!=0) || (check[0][2]!=0 && check[2][0]!=0)){
                                if(check[0][0]!=0){
                                    if(ran==0){
                                        num=2;
                                    }else{
